...
class Options:
    def __init__(self, isTrain):
        ...
        self.exp = 'fib'
        self.exp_num = 'he_baseline'
        self.data_type = 'he'
        self.fusion_type = 'late'
        self.loss_type = 'single'
        ...
        self.train['data_dir'] = '../data_miccai'  # path to data
    ...
    def parse(self):
        ...
        if self.isTrain:
            ...
            parser.add_argument('--data-type', type=str, default=self.data_type, help='H&E or Trichrome')
            parser.add_argument('--fusion-type', type=str, default=self.fusion_type, help='feature fusion')
            parser.add_argument('--loss-type', type=str, default=self.loss_type, help='single loss or multiple loss')
